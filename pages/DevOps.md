...
- DevOps实战笔记
	...
	- **Highlight**
		...
		- [[DevOps]]的价值：[[数字化转型]]时代，DevOps是必选项？
			- 为什么软件如此重要？
		...
		- [[DevOps]]的实施：到底是工具先行还是文化先行？
			...
			- DevOps 的 3 个支柱
				- 对工具和文化的体系化认知，可以归纳到 DevOps 的 3 个支柱之中，即人（People）、[[流程]]（Process）和[[平台]]（Platform）。3 个支柱之间两两组合，构成了我们实施 DevOps 的“正确姿势”，只强调其中一个维度的重要性，明显是很片面的。
				- ![image.png](../assets/image_1641738076025_0.png)
				- 人 + 流程 = 文化
				- 流程 + 平台 = 工具
					- [[平台]]的最大意义，就是承载企业内部的标准化流程。
					- [[平台]]上固化的每一种[[流程]]，其实都是可以用来解决实际问题的工具。
					...
					- 简单来说，平台就是搭台子，工具来唱戏。平台提供场所，进行宣传，吸引用户，同时还能提供演出的道具，以及数据方面的分析。
				- 平台 + 人 = 培训赋能
					-
		- [[DevOps]]的衡量：你是否找到了DevOps的实施路线图？
			- 商业领域有一本特别经典的书，叫作《跨越鸿沟》，这本书中提出了一个“[[技术采纳生命周期定律]]”，对高科技行业来说，它的地位堪比[[摩尔定律]]。
				- ![image.png](../assets/image_1641738597272_0.png)
			...
			- 任何技术的成熟，都是以[[模型]]和框架的稳定为标志的。
				- 因为当技术跨越初期的鸿沟，面对的是广大受众，如果没有一套模型和框架来帮助大众快速跟上节奏，找准方向，是很难大规模推广并健康发展的。
				- 比如，软件开发领域的 CMMI 模型（软件能力成熟度模型）、运维行业的 ITIL 模型等，在各自的领域都久负盛名，甚至一度被各个领域的从业者奉为圭臬和行为准则，成为衡量能力高低的标尺。
				- ![image.png](../assets/image_1641738722903_0.png)
			- 步骤与原则
				- 1.识别差距
				...
				- 4.持续改进
					- ![image.png](../assets/image_1641738896891_0.png)
			- DevOps 的能力[[实践]]和能力框架[[模型]]相辅相成：
				- 能力实践定义了企业落地 DevOps 的路线图和主要建设顺序，能力模型可以指导支撑方法的各类实践的落地建设；
