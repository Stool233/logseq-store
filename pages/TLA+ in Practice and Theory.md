- https://pron.github.io/posts/tlaplus_part2
	...
	- ## **逻辑公式和表达式**
		...
		- ### CHOOSE运算符和未定义的含义
			...
			- 如果没有任何值满足谓词 P，则 CHOOSE x: P(x) 的值是未定义的，这意味着它等于我们值的宇宙中的某个值（我们将在下一节遇到值，但可能的值包括 42、{3, {4, 5}} 或 "hello"），我们无法确定（即在逻辑中证明）。换句话说，“未定义”意味着“我们不知道也不关心。”虽然没有所谓未定义的“值”，但如果我们要给它标注一些符号，一个好的选择可能是 ¯_(ツ)_/¯。