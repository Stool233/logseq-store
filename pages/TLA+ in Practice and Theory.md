...
- https://pron.github.io/posts/tlaplus_part2
	...
	- ## **证明（Proofs）**
		...
		- 虽然TLA+可以用来证明一般数学定理，但它并非为此任务设计。
			- 对形式化证明感兴趣的数学家更适合使用为该任务设计的工具，如Isabelle或Coq。选择编写形式化证明的工程师被鼓励不要浪费时间证明数学定理，而是应使用TLAPS附带的已证明的数学定理库，或者仅仅陈述一个数学定理并省略证明。他们应该专注于证明他们的算法或系统设计的正确性。在第三部分我们将看到如何做到这一点。
	- ## **结论**
